...
NextFunc:
    ...
    Else
        ReDim vFuncArray(1, 1) As Variant
        GetObjectFunctions = vFuncArray
    End If
...
#If Win64 Then
    Private Function ReturnType(Ptr As LongLong) As String
#Else
    Private Function ReturnType(Ptr As Long) As String
#End If
